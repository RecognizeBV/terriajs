...
Cesium.prototype.pickVectorFeatures = function(screenPosition) {
    ...
    for (var i = 0; i < picked.length; ++i) {
        ...
        if (picked[i] instanceof Cesium3DTileFeature) {
            var pickedFeature = picked[i];
            ...
            var feature = new Feature({
                id: pickedFeature._content.url + '.'+ pickedFeature._batchId,
                properties: properties,
                cesium3DTileFeature: pickedFeature,
                entityCollection: {
                    owner: pickedFeature._content.tileset
                }
            });
