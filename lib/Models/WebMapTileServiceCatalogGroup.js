...
function createWmtsDataSource(wmtsGroup, capabilities, layer) {
    // Skip datasources without a  compatible MatrixSet to prevent requests with an invalid GoogleMapsCompatible matrix
    if(WebMapTileServiceCatalogItem.getTileMatrixSet(layer, capabilities) === null) {
        return null;
    }
